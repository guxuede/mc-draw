...
public class OBJModel {
     ...
     * @return non-null writable list of {@link Vector3} 
     * instances.
     */
     ...
     * @return the referred vertex as an {@link Vector3} instance.
     * @throws ArrayIndexOutOfBoundsException if the vertex index in the
     * reference is invalid
     */
    public Vector3 getVertex(OBJDataReference reference) {
